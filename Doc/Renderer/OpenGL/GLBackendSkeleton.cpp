// Reference implementation (Doc-only). Not compiled in the engine; intended for design review.
// Wrapped in #if 0 to avoid toolchain parsing this file.
...
namespace SoulEngine::Gfx::GL
{
    ...
    static GLenum ToUsage(BufferUsage u)
    {
        ...
        case BufferUsage::Staging:   return GL_STREAM_DRAW; // doc default
        case BufferUsage::Default:
        default:                     return GL_STATIC_DRAW;
        }
    }

    struct AttribInfo { GLenum type; GLint comps; GLboolean norm; };
    ...
    {
        switch (mode) {
        case MapMode::Read:           return GL_MAP_READ_BIT;
        case MapMode::Write:          return GL_MAP_WRITE_BIT;
        case MapMode::WriteDiscard:   return GL_MAP_WRITE_BIT | GL_MAP_INVALIDATE_BUFFER_BIT;
        case MapMode::WriteNoOverwrite: return GL_MAP_WRITE_BIT | GL_MAP_UNSYNCHRONIZED_BIT;
        }
    ...
    {
    public:
        ~GLVertexInputLayout() override { if (vao) glDeleteVertexArrays(1, &vao); }
        GLuint vao = 0;
    ...
    public:
        ...
        void SetVertexInputLayout(IVertexInputLayout* layout) override
        {
            ...
            for (const auto& a : glLayout->attributes) {
                ...
                if (a.stepRate > 1) glVertexAttribDivisor(loc, 1);
            }
        }
