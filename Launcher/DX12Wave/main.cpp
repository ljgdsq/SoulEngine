...
WaveApp::WaveApp(HINSTANCE hInstance): D3DApp(hInstance)
{
}

WaveApp::~WaveApp()= default;

bool WaveApp::Initialize()
{
...
void WaveApp::Update(const GameTimer& gt)
{
    D3DApp::Update(gt);
    OnKeyboardInput(gt);
	UpdateCamera(gt);
...
void WaveApp::Draw(const GameTimer &gt)
{
...
void WaveApp::OnKeyboardInput(const GameTimer& gt)
{
...
void WaveApp::UpdateCamera(const GameTimer& gt)
{
...
void WaveApp::UpdateObjectCBs(const GameTimer& gt)
{
...
void WaveApp::UpdateMainPassCB(const GameTimer& gt)
{
...
void WaveApp::UpdateWaves(const GameTimer& gt)
{
...
// mWavesRitem->Geo->VertexBufferByteSize = mWaves->VertexCount() * sizeof(Vertex);


}


void WaveApp::BuildRootSignature()
{
...
void WaveApp::BuildShadersAndInputLayout()
{
...
void WaveApp::BuildLandGeometry()
{
...
void WaveApp::BuildFrameResources()
{
...
void WaveApp::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<RenderItem*>& ritems)
{
...
float WaveApp::GetHillsHeight(float x, float z)const
{
	return 0.3f*(z*sinf(0.1f*x) + x*cosf(0.1f*z));
}

XMFLOAT3 WaveApp::GetHillsNormal(float x, float z)const
{
	// n = (-df/dx, 1, -df/dz)
	XMFLOAT3 n(
