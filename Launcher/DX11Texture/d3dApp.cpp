...
bool D3DApp::InitImgui(){
    ...
    // io.ConfigFlags |= ImGuiConfigFlags_DockingEnable;         // 启用停
...
bool D3DApp::InitDirect3D()
{
    ...
    for(UINT driverTypeIndex=0;driverTypeIndex<numDriverTypes;driverTypeIndex++)
    {
        ...
        hr = D3D11CreateDevice(nullptr,d3dDriverType,nullptr,createDeviceFlags,
            ...
            m_pd3dDevice.GetAddressOf(),&d3dFeatureLevel,m_pd3dImmediateContext.GetAddressOf());
        if (hr == E_INVALIDARG)
        {
            // DirectX 11.0 设备不支持 11.1 的功能等级，所以我们去掉它然后重试
            hr = D3D11CreateDevice(nullptr, d3dDriverType, nullptr, createDeviceFlags,
